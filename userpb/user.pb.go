...
type GetUserResponse struct {
	...
	UserAge       int64                  `protobuf:"varint,3,opt,name=UserAge,proto3" json:"UserAge,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetUserResponse) GetUserAge() int64 {
	if x != nil {
		return x.UserAge
	}
	return 0
...
var file_proto_user_proto_rawDesc = string([]byte{
	...
	0x72, 0x41, 0x67, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x55, 0x73, 0x65, 0x72,
